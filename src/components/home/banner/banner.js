  ...
  return (
    <Container className="my-4">
      <div className="text-center py-4">
        <h1 className="text-info">Know why we are best</h1>
        <h5 className="text-uppercase banner-title">
      ...
      <Row>
        <Col>
          ...
          <p>We provide best quality Courses for you via apps and website.</p>
